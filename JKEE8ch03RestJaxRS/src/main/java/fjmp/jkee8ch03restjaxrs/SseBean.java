...
// we have a bean to manage the UI and help us with a better 
// view of what is happening in the server
@ViewScoped
@Named
public class SseBean implements Serializable {
    ...
    public void sendEvent() throws URISyntaxException, InterruptedException {
        ...
        WebTarget target = client.target(URI.create("http://localhost:8080/JKEE8ch03RestJaxRS"));
        Response response =
        ...
        final String processUriString = 
                target.getUri()
                       .relativize(response.getLocation())
                       .toString();
